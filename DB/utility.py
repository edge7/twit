...
def insert(table,
    ...
    try:
        ...
        %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s  )""", (
            ...
            first_hashtag_most_used, first_hashtag_most_used_count, second_hashtag_most_used,
            second_hashtag_most_used_count,
            comment_with_most_likes, likes_to_most_comment, comment_sentiment, topic, comm_2, comm_2_likes, comm_3, comm_3_likes, "NA"
        ))
        conn.commit()
...
def insertFacebook(table, id_post, message, c_time, first_word_most_used_in_comments,
    ...
    try:
        ret = x.execute(" INSERT INTO " + table + """ VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
            ...
            first_hashtag_most_used, first_hashtag_most_used_count, second_hashtag_most_used,
            second_hashtag_most_used_count,
            comment_with_most_likes, likes_to_most_comment, sentiment, topic, sec_comment, sec_comment_likes, third_comment, third_comment_likes, "NA"
        ))
        conn.commit()
    except Exception as e:
        logger.error("ERROR DB ")
